/* ------------------------------------------------------------------
   artwork.js — the illustration set bundled with the app.

   Wikimedia photographs need a network and do not exist for every
   district. These illustrations ship inside the app, so the interface
   is never empty and never depends on a connection. They are always
   badged "Illustration" in the UI — a painting of "a South Indian
   temple town" is never presented as a photograph of a specific
   monument. Specific monuments only ever show a verified photograph,
   or an honest "Photo needed" tile.
------------------------------------------------------------------- */
const ART = {
  dir: 'img/art/',
